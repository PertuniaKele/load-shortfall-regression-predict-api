...
def _preprocess_data(data):
    ...
    feature_vector_df = feature_vector_df.drop(['Unnamed: 0','time','Valencia_wind_deg', 'Bilbao_rain_1h',
       'Seville_humidity', 'Madrid_humidity',
       'Bilbao_clouds_all', 'Seville_clouds_all',
       'Bilbao_wind_deg',  'Barcelona_wind_deg',
       'Madrid_clouds_all', 'Barcelona_rain_1h',
       ...
       'Barcelona_temp_max', 'Madrid_temp_max','Bilbao_temp_min', 'Barcelona_temp_min',
       'Bilbao_temp_max', 'Seville_temp_min', 'Madrid_temp_min'], axis = 1)

    predict_vector = feature_vector_df[['Madrid_wind_speed', 'Valencia_wind_speed', 'Bilbao_wind_speed',
       'Barcelona_wind_speed', 'Seville_wind_speed', 'Seville_temp',
